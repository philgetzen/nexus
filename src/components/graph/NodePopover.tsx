...
export function NodePopover({ content, x, y }: NodePopoverProps) {
  ...
  return (
    <g transform={`translate(${x + 30}, ${y - 60})`} data-testid="node-popover">
      {/* Popover background */}
      <foreignObject width={220} height={120} className="overflow-visible">
        <div className="bg-zinc-900/95 backdrop-blur-sm border border-zinc-700 rounded-lg shadow-xl p-3 text-left">
          {/* Header */}
